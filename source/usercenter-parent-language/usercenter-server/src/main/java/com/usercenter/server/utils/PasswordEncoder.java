...
public class PasswordEncoder {
    ...
    public PasswordEncoder(@Value("${user.password.salt:Plat}") Object salt, @Value("${user.password.algorithm:MD5}") String algorithm) {
        this.salt = salt;
    ...
    public static void main(String[] args) {
        ...
        String encode = encoderMd5.encode("Plat123456");
...
//
//        System.out.println(encoderSha.encode("admin123"));
    }
}
