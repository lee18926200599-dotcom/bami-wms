...
@Data
public class BasePlatformStoreReqDTO {
    ...
    @ApiModelProperty(value = "授权店铺编码（全模糊查询）")
    private String authStoreCodeLike;

    @ApiModelProperty(value = "授权店铺名称")
    private String authStoreName;

    @ApiModelProperty(value = "授权店铺名称（全模糊查询）")
    private String authStoreNameLike;
