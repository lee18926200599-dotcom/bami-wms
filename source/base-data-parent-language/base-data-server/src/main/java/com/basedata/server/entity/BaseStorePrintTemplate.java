 ...
 */
@Data
@TableName("base_store_print_template")
@ApiModel(value = "BaseStorePrintTemplate对象", description = "快递面单模版配置")
public class BaseStorePrintTemplate implements Serializable {
