...
public class QueryGroupBUByFuncReqParam implements Serializable {
	...
	@ApiModelProperty(value = "职能类型(选填)(1法人公司；2财务；3采购；4销售；5仓储；6物流；7金融；8劳务；9平台)")
	...
	@ApiModelProperty(value = "无职能类型(选填)(1法人公司；2财务；3采购；4销售；5仓储；6物流；7金融；8劳务；9平台)")
	...
	@ApiModelProperty(value = "根业务单元（1:是 0:否）")
