...
*/ 
 ...
 @ApiModel(description = "集团-管理维度表", value = "集团-管理维度表")
public class BasePermissionGroupManagementVo extends BaseQuery implements Serializable {
	@ApiModelProperty(value="")
	private Integer id; // 
	@ApiModelProperty(value="集团id") 
	private Integer groupId; //集团id 
	@ApiModelProperty(value="管理维度id") 
	private Integer managementId; //管理维度id 
