...
public class BaseEntrustRelationshipDto implements Serializable {
	...
	private String purchaseSaleOrgName;

	@ApiModelProperty(value = "仓储服务商")//全局客户Id
	...
	@ApiModelProperty(value = "应收应付组织名称")
	private String payReceiveOrgName;
	...
	@ApiModelProperty(value = "关联物流服务商名称")
