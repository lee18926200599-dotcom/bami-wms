...
public class IdWorkerCopy {

    private final static Logger logger = LoggerFactory.getLogger(IdWorkerCopy.class);
    ...
    private IdWorkerCopy(long workerId) {
    ...
    private static IdWorkerCopy flowIdWorker = new IdWorkerCopy(1);

    public static IdWorkerCopy getFlowIdWorkerInstance() {
        return flowIdWorker;
    }
